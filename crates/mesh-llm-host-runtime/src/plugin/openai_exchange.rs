...
/// Python reference's `_stringify_floats`).
...
mod tests {
    ...
    fn twin_bracket_id_round_trips_on_both_dispatch_paths() {
        let primary =
            OpenAiExchangeEnvelope::terminal_remote_mesh("exch-a", "m", Some(200), None, None)
                .with_twin_bracket_id("twin-abc".to_string());
        let twin =
            OpenAiExchangeEnvelope::terminal_remote_mesh("exch-b", "m", Some(200), None, None)
                .with_twin_bracket_id("twin-abc".to_string());
