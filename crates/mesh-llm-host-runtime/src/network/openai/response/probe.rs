...
/// peer reading it back off this node's public response would see nothing and
/// seal `peer_capsule_id: null`. CR/LF-stripped defensively even though the
/// value is a self-minted `capsule-<id>`.
